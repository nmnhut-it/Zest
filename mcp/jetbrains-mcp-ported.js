...
/* harmony export */ });
/* harmony import */ var _modelcontextprotocol_sdk_server_index_js__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(150);
/* harmony import */ var _modelcontextprotocol_sdk_server_stdio_js__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(63);
/* harmony import */ var _modelcontextprotocol_sdk_types_js__WEBPACK_IMPORTED_MODULE_2__ = __nccwpck_require__(477);
 ...
 * Main MCP server
 */
const server = new _modelcontextprotocol_sdk_server_index_js__WEBPACK_IMPORTED_MODULE_0__/* .Server */ .g({
 ...
 */
server.setRequestHandler(_modelcontextprotocol_sdk_types_js__WEBPACK_IMPORTED_MODULE_2__/* .ListToolsRequestSchema */ .gW, async () => {
 ...
 */
server.setRequestHandler(_modelcontextprotocol_sdk_types_js__WEBPACK_IMPORTED_MODULE_2__/* .CallToolRequestSchema */ .FT, async (request) => {
...
async function runServer() {
    ...
    const transport = new _modelcontextprotocol_sdk_server_stdio_js__WEBPACK_IMPORTED_MODULE_1__/* .StdioServerTransport */ .S();
    try {
...
var types = __nccwpck_require__(477);
...
class Protocol {
    ...
    _resetTimeout(messageId) {
        ...
        if (info.maxTotalTimeout && totalElapsed >= info.maxTotalTimeout) {
            ...
            throw new types/* McpError */.Nh(types/* ErrorCode */.O4.RequestTimeout, "Maximum total timeout exceeded", { maxTotalTimeout: info.maxTotalTimeout, totalElapsed });
        }
    ...
    _onclose() {
        ...
        const error = new types/* McpError */.Nh(types/* ErrorCode */.O4.ConnectionClosed, "Connection closed");
            ...
            return (_a = this._transport) === null || _a === void 0 ? void 0 : _a.send({
                ...
                error: {
                    code: Number.isSafeInteger(error["code"])
                        ? error["code"]
                        : types/* ErrorCode */.O4.InternalError,
    ...
    request(request, resultSchema, options) {
        return new Promise((resolve, reject) => {
            ...
            const timeoutHandler = () => cancel(new types/* McpError */.Nh(types/* ErrorCode */.O4.RequestTimeout, "Request timed out", { timeout }));
...
class Server extends Protocol {
    ...
    constructor(_serverInfo, options) {
        ...
        this.setRequestHandler(types/* InitializeRequestSchema */.rk, (request) => this._oninitialize(request));
        this.setNotificationHandler(types/* InitializedNotificationSchema */.ZC, () => { var _a; return (_a = this.oninitialized) === null || _a === void 0 ? void 0 : _a.call(this); });
    }
    /**
    ...
    async _oninitialize(request) {
        ...
        return {
            protocolVersion: types/* SUPPORTED_PROTOCOL_VERSIONS */.Iu.includes(requestedVersion)
                ? requestedVersion
                : types/* LATEST_PROTOCOL_VERSION */.aE,
    ...
    async ping() {
        return this.request({ method: "ping" }, types/* EmptyResultSchema */.wR);
    }
    async createMessage(params, options) {
        return this.request({ method: "sampling/createMessage", params }, types/* CreateMessageResultSchema */.K1, options);
    }
    async listRoots(params, options) {
        return this.request({ method: "roots/list", params }, types/* ListRootsResultSchema */.Cs, options);
    }
...
// EXPORTS
__nccwpck_require__.d(__webpack_exports__, {
  S: () => (/* binding */ StdioServerTransport)
});
...
// EXPORTS
__nccwpck_require__.d(__webpack_exports__, {
  FT: () => (/* binding */ CallToolRequestSchema),
  ...
  rk: () => (/* binding */ InitializeRequestSchema),
  ZC: () => (/* binding */ InitializedNotificationSchema),
  OR: () => (/* binding */ JSONRPCMessageSchema),
  aE: () => (/* binding */ LATEST_PROTOCOL_VERSION),
  Cs: () => (/* binding */ ListRootsResultSchema),
  gW: () => (/* binding */ ListToolsRequestSchema),
  Nh: () => (/* binding */ McpError),
...
// UNUSED EXPORTS: AudioContentSchema, BlobResourceContentsSchema, CallToolResultSchema, ClientCapabilitiesSchema, ClientNotificationSchema, ClientRequestSchema, ClientResultSchema, CompatibilityCallToolResultSchema, CompleteRequestSchema, CompleteResultSchema, CreateMessageRequestSchema, CursorSchema, EmbeddedResourceSchema, GetPromptRequestSchema, GetPromptResultSchema, ImageContentSchema, ImplementationSchema, InitializeResultSchema, JSONRPCErrorSchema, JSONRPCNotificationSchema, JSONRPCRequestSchema, JSONRPCResponseSchema, JSONRPC_VERSION, ListPromptsRequestSchema, ListPromptsResultSchema, ListResourceTemplatesRequestSchema, ListResourceTemplatesResultSchema, ListResourcesRequestSchema, ListResourcesResultSchema, ListRootsRequestSchema, ListToolsResultSchema, LoggingLevelSchema, LoggingMessageNotificationSchema, ModelHintSchema, ModelPreferencesSchema, NotificationSchema, PaginatedRequestSchema, PaginatedResultSchema, ProgressSchema, ProgressTokenSchema, PromptArgumentSchema, PromptListChangedNotificationSchema, PromptMessageSchema, PromptReferenceSchema, PromptSchema, ReadResourceRequestSchema, ReadResourceResultSchema, RequestIdSchema, RequestSchema, ResourceContentsSchema, ResourceListChangedNotificationSchema, ResourceReferenceSchema, ResourceSchema, ResourceTemplateSchema, ResourceUpdatedNotificationSchema, ResultSchema, RootSchema, RootsListChangedNotificationSchema, SamplingMessageSchema, ServerCapabilitiesSchema, ServerNotificationSchema, ServerRequestSchema, ServerResultSchema, SetLevelRequestSchema, SubscribeRequestSchema, TextContentSchema, TextResourceContentsSchema, ToolListChangedNotificationSchema, ToolSchema, UnsubscribeRequestSchema
...
/******/ var __webpack_exports__log = __webpack_exports__.R;
