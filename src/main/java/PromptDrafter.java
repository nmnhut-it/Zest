public class PromptDrafter {
    ...
    public static String createPrompt(String packageName, String className, String methodName,
                                      String methodSignature, String methodBody, String imports, String junitVersion, String methodContext) {
        // Validate and sanitize package name
        packageName = validatePackageName(packageName);

        StringBuilder promptBuilder = new StringBuilder();
        promptBuilder.append("Generate a comprehensive ").append(junitVersion).append(" test suite for the following Java method:\n\n");
        ...
        promptBuilder.append("   - Each test method should verify a single behavior\n");
        ...
        promptBuilder.append("4. Include these test scenarios:\n");
        ...
        promptBuilder.append("   - Error cases (if the method throws exceptions)\n");
        promptBuilder.append("   - Any specific business logic edge cases relevant to this method\n");
        ...
        promptBuilder.append("   - Avoid mocking. If required, please use Mockito for mocking dependencies\n");
        ...
        promptBuilder.append("   - Testing strategy for complex methods\n");
        ...
        promptBuilder.append("    - Create realistic test data that matches method requirements\n");
    ...
    private static void appendAssertionRequirements(StringBuilder promptBuilder, String junitVersion) {
        promptBuilder.append("5. For assertions, use ONLY these methods with EXACT signatures and imports:\n");

        if (junitVersion.equals("JUnit 5")) {
            promptBuilder.append("   Import: import org.junit.jupiter.api.Assertions;\n\n");
            promptBuilder.append("   Method signatures:\n");
            promptBuilder.append("   - static void assertEquals(expected, actual, String message)\n");
            promptBuilder.append("   - static void assertTrue(boolean condition, String message)\n");
            promptBuilder.append("   - static void assertFalse(boolean condition, String message)\n");
            promptBuilder.append("   - static void assertNull(Object object, String message)\n");
            promptBuilder.append("   - static void assertNotNull(Object object, String message)\n");
            promptBuilder.append("   - static <T extends Throwable> T assertThrows(Class<T> expectedType, Executable executable)\n");
            promptBuilder.append("   - static void assertArrayEquals(expected[], actual[], String message)\n");
            promptBuilder.append("   - static void assertIterableEquals(Iterable<?> expected, Iterable<?> actual, String message)\n");
            promptBuilder.append("   - static void assertTimeout(Duration timeout, Executable executable)\n");

            promptBuilder.append("\n   Example usage:\n");
            promptBuilder.append("   - Assertions.assertEquals(expectedValue, actualValue, \"Values should match\");\n");
            promptBuilder.append("   - Assertions.assertTrue(condition, \"Condition should be true\");\n");
            promptBuilder.append("   - Exception exception = Assertions.assertThrows(IllegalArgumentException.class, () -> method());\n");
        } else {
            promptBuilder.append("   Import: import org.junit.Assert;\n\n");
            promptBuilder.append("   Method signatures:\n");
            promptBuilder.append("   - static void assertEquals(String message, Object expected, Object actual)\n");
            promptBuilder.append("   - static void assertTrue(String message, boolean condition)\n");
            promptBuilder.append("   - static void assertFalse(String message, boolean condition)\n");
            promptBuilder.append("   - static void assertNull(String message, Object object)\n");
            promptBuilder.append("   - static void assertNotNull(String message, Object object)\n");
            promptBuilder.append("   - static void assertArrayEquals(String message, Object[] expected, Object[] actual)\n");
            promptBuilder.append("   - static void fail(String message)\n");

            promptBuilder.append("\n   Exception testing options:\n");
            promptBuilder.append("   - @Test(expected = ExceptionClass.class) annotation\n");
            promptBuilder.append("   - Using ExpectedException rule:\n");
            promptBuilder.append("     Import: import org.junit.rules.ExpectedException;\n");
            promptBuilder.append("     Field: @Rule public ExpectedException thrown = ExpectedException.none();\n");
            promptBuilder.append("     Usage: thrown.expect(ExceptionClass.class);\n");

            promptBuilder.append("\n   Example usage:\n");
            promptBuilder.append("   - Assert.assertEquals(\"Values should match\", expectedValue, actualValue);\n");
            promptBuilder.append("   - Assert.assertTrue(\"Condition should be true\", condition);\n");
            promptBuilder.append("   - Assert.fail(\"Should not reach this point\");\n");
        }

        promptBuilder.append("\n   IMPORTANT:\n");
        promptBuilder.append("   - Include descriptive failure messages in all assertions\n");
        promptBuilder.append("   - Pay close attention to parameter order (different in JUnit 4 vs JUnit 5)\n");
        promptBuilder.append("   - Verify all relevant side effects and return values\n");
    }

    private static void appendImportRequirements(StringBuilder promptBuilder, String junitVersion, String packageName) {
        promptBuilder.append("8. Include EXACTLY these necessary imports (do not use wildcard imports):\n");

        if (junitVersion.equals("JUnit 5")) {
            promptBuilder.append("   - JUnit 5 core imports:\n");
            promptBuilder.append("     import org.junit.jupiter.api.Assertions;\n");
            ...
            promptBuilder.append("     import org.junit.Assert;\n");
        ...
        promptBuilder.append("   - Mockito imports:\n");
        ...
        promptBuilder.append("\n   - Import the class being tested and any dependencies:\n");
        promptBuilder.append("     import ").append(packageName).append(".*;\n");
        promptBuilder.append("     // Plus any other dependencies needed by the class under test\n\n");

        promptBuilder.append("   - Common Java utility imports that may be needed:\n");
        ...
        promptBuilder.append("     import java.util.function.*;\n");
        promptBuilder.append("     import java.io.*;\n");
        promptBuilder.append("     import java.time.*;\n");
    }
}