...
/**
 * Action to execute JavaScript code in the web browser.
 */
public class RunJavaScriptAction extends AnAction {
    private static final Logger LOG = Logger.getInstance(RunJavaScriptAction.class);
    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
        ...
        int result = Messages.showYesNoDialog(
                project,
                "Execute the selected JavaScript code in the browser?",
                "Execute JavaScript",
                "Execute",
                "Cancel",
        ...
        LOG.info("Executing JavaScript in browser");

        // Get browser service
        WebBrowserService browserService = WebBrowserService.getInstance(project);
        browserService.executeJavaScript(selectedText);
