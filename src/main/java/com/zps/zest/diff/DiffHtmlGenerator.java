...
public class DiffHtmlGenerator {
    ...
    private static String generateDiff2HtmlWithCDN(String diffText, String filePath, boolean isDarkTheme) {
        ...
        html.append("        }\n");
        html.append("        \n");
        html.append("        /* Force consistent row height */\n");
        html.append("        .d2h-diff-tbody tr {\n");
        html.append("            min-height: 20px !important;\n");
        html.append("        }\n");
        html.append("        \n");
        ...
        html.append("        }\n");
        html.append("        \n");
        html.append("        /* Ensure proper line spacing for content rows */\n");
        html.append("        .d2h-diff-tbody tr {\n");
        html.append("            line-height: 20px !important;\n");
        html.append("        }\n");
        html.append("        \n");
        html.append("        .d2h-code-line-num {\n");
        html.append("            line-height: 20px !important;\n");
        html.append("            height: auto !important;\n");
        html.append("        }\n");
        html.append("        \n");
        ...
        html.append("        }\n");
        html.append("        \n");
        html.append("        /* Override any default diff2html line heights */\n");
        html.append("        .d2h-diff-table td.d2h-code-linenumber,\n");
        html.append("        .d2h-diff-table td.d2h-code-line {\n");
        html.append("            line-height: 20px !important;\n");
        html.append("            min-height: 20px !important;\n");
        html.append("            padding-top: 0 !important;\n");
        html.append("            padding-bottom: 0 !important;\n");
