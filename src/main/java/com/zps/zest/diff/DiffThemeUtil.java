...
public class DiffThemeUtil {
    ...
    private static final class GithubLight {
        ...
        static final Color ADDITION_BG = new Color(0xE6FFEC);
        static final Color ADDITION_BORDER = new Color(0xABF2BC);
        static final Color DELETION_BG = new Color(0xFFEBE9);
        static final Color DELETION_BORDER = new Color(0xFFCECB);
    ...
    private static final class GithubDark {
        ...
        static final Color ADDITION_BG = new Color(0x0D4429);
        static final Color ADDITION_BORDER = new Color(0x2EA043);
        static final Color DELETION_BG = new Color(0x42181C);
    ...
    public static String getGithubStyleCss() {
        ...
        return "body { " +
               ...
               ".addition { background-color: " + colorToHex(isLight ? GithubLight.ADDITION_BG : GithubDark.ADDITION_BG) + "; } " +
               ".addition .line-content { border-left: 1px solid " + colorToHex(isLight ? GithubLight.ADDITION_BORDER : GithubDark.ADDITION_BORDER) + "; } " +
               ".deletion { background-color: " + colorToHex(isLight ? GithubLight.DELETION_BG : GithubDark.DELETION_BG) + "; } " +
               ".deletion .line-content { border-left: 1px solid " + colorToHex(isLight ? GithubLight.DELETION_BORDER : GithubDark.DELETION_BORDER) + "; } " +
               ".diff-hunk-header { " +
