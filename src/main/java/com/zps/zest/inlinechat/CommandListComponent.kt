...
/**
 * Data class representing an item in the command list
 */
...
/**
 * Component for displaying and interacting with a list of commands
 */
...
/**
 * Custom renderer for the command list items
 */
class CustomListItemRenderer(private val getHoveredIndex: () -> Int) : JPanel(), ListCellRenderer<CommandListItem> {
    ...
    override fun getListCellRendererComponent(
        ...
        if (value.canDelete) {
            ...
            if (isHovered) {
                deleteButton.icon = DELETE_ICON_HOVERED
            } else {
