...
// import com.zps.zest.testgen.TestGenerationService // Disabled - using state machine now
...
class AgentDebugDialog(
    ...
    // private val service = project.getService(TestGenerationService::class.java) // Disabled
